...
export default class Main extends Component <{account: any, stravaOAuth: any, code: string}, {step: Number, account: any}> {
  constructor(props) {
    super(props);
    this.state = {
      step: 1,
    ...
    switch(this.state.step) {
        ...
        case 6:
			...
			<LinearGradient
          		...
          		style={styles.linearGradient}
        		>
                <MakeCommitment next={this.onClick} account={this.props.account} code={this.props.code}></MakeCommitment>
</LinearGradient>
            )
        case 7:
            return (
                <Track next={this.onClick} account={this.props.account} code={this.props.code}></Track>
            )
        case 8:
            return (
